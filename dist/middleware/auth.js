...
const verifyAccessToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        jsonwebtoken_1.default.verify(token, process.env.ACCESS_TOKEN_SECRET, (err, user) => {
            if (err) {
                if (err instanceof jsonwebtoken_1.TokenExpiredError) {
                    return res.status(401).json(response_1.ApiResponse.errorResponse(401, "Token expired"));
                }
                return res.status(401).json(response_1.ApiResponse.errorResponse(401, "Invalid access token"));
            }
            req.user = user;
        ...
        res.status(401).json(response_1.ApiResponse.errorResponse(401, "Server Internal Error"));
    }
});
